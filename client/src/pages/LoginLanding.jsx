      ...
      p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
          <div className="mb-10 text-center md:text-left"> 
            <h2 className="text-3xl font-medium text-slate-990
          ...
          <div className="space-y-4">
            {
              portalOptions.map((portal)=>(
                ...
                p-5 sm:p-6 transition-all duration-300 hover:border-indigo-400
                hover:bg-indigo-50">
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>© {new Date().getFullYear()} ShikharGupta. All rights reserved. </p>
          </div>
